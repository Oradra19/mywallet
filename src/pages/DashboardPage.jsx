  ...
  return (
    <div className="space-y-6">
      <header className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <p className="text-sm font-semibold uppercase tracking-wide text-slate-500">Wallet Overview</p>
          <h1 className="mt-1 text-2xl font-semibold text-slate-950">Welcome, {currentUser.name}</h1>
      ...
      <section className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_minmax(320px,420px)]">
        <div className="space-y-4">
          <TransactionTable currentUser={currentUser} transactions={paginatedTransactions} />
          <Pagination
